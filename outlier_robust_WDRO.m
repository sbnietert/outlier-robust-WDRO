function [theta_star, obj_star] = outlier_robust_WDRO(X, y, sigma, rho, vareps, z_0, dual_norm, verbose)
% This implementation is for p = 1, q = 2, and Z = R^d
    ...
    for i = 1 : n
        constraints{i} = [s(i) >= z_0' * zeta_G(:, i, 1) + tau(:, i, 1) + Z(i,:) * zeta_W(:,i, 1) - alpha;
